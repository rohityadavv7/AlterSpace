    ...
    className='relative h-[300vh]  w-screen flex flex-col items-center z-10 bg-zinc-950 font-["Six_Caps"] text-white'>
...

        {
            ...
            (<div className='w-screen   h-screen mt-5 flex mx-auto text-center justify-center items-center'>
                <motion.div ref={scope} className='flex flex-col text-6xl md:text-7xl lg:text-9xl space-y-5'>
                    <Link to={"/"}>
                        <motion.div 
            ...
            <div className='w-screen mx-auto flex flex-col items-center'>
                <motion.div 
                    ref={scope}
                    className='text-[10rem] sm:text-[13rem] md:text-[15rem] lg:text-[18rem]  h-[28rem] relative z-1000  mt-10 flex items-center from-amber-50  to-zinc-800
