  ...
  return (
    <div className="flex relative w-full h-[100vh] overflow-hidden font-['Neue_Haas_Grotesk_Text_Pro'] bg-newBlack">
        ...
        <div className=" relative hidden md:w-[60%] md:justify-end rounded-t-3xl md:items-center md:flex  flex-col  bg-new-violet-200 overflow-hidden h-full">
           <div className="w-[60%] flex flex-col space-y-0 p-10 items-center text-white  z-100">
                <div className="flex relative items-center flex-col text-white">
                    <span className=" absolute md:-top-2 lg:-top-20 md:text-[3rem] lg:text-[6rem]">Join the</span>
                 
                    <div className="md:text-[11rem] lg:text-[14rem] from-white to-newBlack
                    bg-clip-text text-transparent bg-gradient-to-b">Space</div>   
                </div>  

                <div className="text-zinc-500 w-full text-center text-sm lg:text-md font-['Neue_Montreal'] tracking-wide">
        ...
        <div className="w-full md:w-[40%] flex items-center bg-newBlack font-['Neue_Montreal'] z-100">
          <div className="w-[76%] h-[98%] md:h-[95%] p-4 mx-auto outline-1 overflow-hidden outline-amber-50/20 relative rounded-2xl">
            <div className="absolute h-100 w-100 left-1/2 -top-40 blur-3xl -translate-x-[50%] rounded-full bg-white/10"></div>
            <div className="text-white  flex flex-col items-center">
           
            
                <div className='text-3xl md:text-4xl lg:text-5xl mt-4 
              ...
              <div className=' mt-2 md:mt-4 p-2 md:p-4 flex items-center space-x-4 '>
                <div className='rounded-full p-2  md:p-3 lg:p-4 outline-1 '>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-5 md:size-7 lg:size-11">
              ...
              <div className='mt-2 text-xs lg:text-md text-zinc-400'>please enter your details to sign up with us.</div>

              <div className='flex mt-6 flex-col w-[85%]'>
                <form onSubmit={handleSubmit(Signup as any)} 
                className='flex flex-col space-y-3 md:space-y-5 z-100 text-xl'>
                  <label>
                    <div className='font-["Neue_Haas_Grotesk_Text_Pro"]/40 tracking-wider text-sm md:text-lg text-white/80 '>Username :</div>
                    <input type='text'
                    className='w-full py-2 mt-2 px-4 md:px-6 outline-1  outline-amber-50/40 rounded-xl'
                    placeholder='username...' {...register("username")}/>
                  </label>

                  <label>
                  <div className='font-["Neue_Haas_Grotesk_Text_Pro"]/40 tracking-wider text-sm md:text-lg text-white/80'>Password :</div>
                    ...
                    placeholder='password...' {...register("password")}/>
                    {
                        ...
                        :
                        (<svg onClick={() => setShowPass((prev)=> !prev)}
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className=" text-zinc-500 cursor-pointer size-6 relative -top-8.5 -right-45 md:-right-75">
                  ...
                  <label>
                  <div className='font-["Neue_Haas_Grotesk_Text_Pro"]/40 tracking-wider text-sm md:text-lg text-white/80'>Confirm Password :</div>
                ...
                <div className='mt-4 mx-auto'>
                  <div className='text-zinc-400 text-sm md:text-md'>
